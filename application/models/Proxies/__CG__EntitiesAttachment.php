 ...
 */
class Attachment extends \Entities\Attachment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'url', 'active', 'created', 'deleted', 'deletedUser', 'user', 'category');
    }
